                        ...
                        <div class="card-body">
                            ...
                            <div class="card-actions" style="justify-content: flex-start; padding-top:10px;">
                                ...
                                <?php if(isset($_SESSION['id']) && isset($row['user_id']) && $row['user_id'] == $_SESSION['id']): ?>
                                    <!-- Edit -->
                                    <a href="educational_resources_edit.php?id=<?php echo $row['id']; ?>" class="btn-edit" style="width: auto; padding: 6px 12px; display:inline-block; text-align:center;" title="Edit"><i class="fa fa-edit"></i></a>

                                    <!-- Delete -->
                                    <form action="./controllers/client/ClientEducationalController.php" method="POST" style="display:inline; width: auto;">
