...
<body class="admin-body">
    ...
    <div class="main-content">
        ...
        <div style="margin-bottom: 20px; text-align: right;">
            <form method="GET" action="educational_resources.php" style="display: inline-block;">
                ...
                <?php if(isset($_GET['search'])): ?>
                    <a href="educational_resources.php" class="admin-btn" style="padding: 8px 15px; font-size: 14px; background: #666; margin-left: 5px; text-decoration:none;">Clear</a>
                <?php endif; ?>
            </form>
        </div>
