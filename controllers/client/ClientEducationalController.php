...
if (isset($_POST['create_resource'])) {
    ...
    if ($stmt->execute()) {
        header("Location: ../../educational_resources.php?msg=Resource Added");
    } else {
...
if (isset($_POST['update_resource'])) {
    ...
    if ($stmt->execute()) {
        header("Location: ../../educational_resources.php?msg=Updated");
    } else {
        echo "Error: " . $stmt->error;
    }
}
...
if (isset($_POST['delete_resource'])) {
    ...
    if (!$stmt) die("Prepare failed (Delete): " . $connection->error);
    $stmt->bind_param("i", $id);

    if ($stmt->execute()) {
        header("Location: ../../educational_resources.php?msg=Deleted");
    } else {
        echo "Error: " . $stmt->error;
    }
}
